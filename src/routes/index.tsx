...
export default component$(() => {
  return (
    ...
    <div >
        <Link href="Trips"  class="block px-6 py-3 rounded-full bg-gradient-to-r from-rose-500 to-red-500  text-center text-white hover:scale-110 transition-all duration-300 ease-in-out font-semibold">See All</Link>
    </div>
   </div>
